            ...
            <main className="max-w-2xl mx-auto px-4 pt-24 pb-12">
                <div className="text-center mb-10">
                    <div className="flex items-center justify-center gap-3 mb-3">
                        <Image src="/logos/airachne.png" alt="Airachne" width={36} height={36} className="rounded-lg" />
                        <h1 className="text-4xl font-bold text-[#eae6df] heading-serif">
                            Airachne → <span className="text-[#00d4aa] italic">Prometheus</span>
                        </h1>
                    </div>
                    <p className="text-[#a8b8d0]">Claim free Prometheus points using your AIR balance as credential</p>
                    <p className="text-xs text-[#7a8a9d] mt-1">Your AIR points remain on Airachne — this is a bonus grant, not a transfer.</p>
                </div>
                ...
                {step === "input" && (
                    <div className="bg-[#0f1019] border border-white/10 rounded-2xl p-6 space-y-5">
                        ...
                        <button
                            disabled={true}
                            className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#00d4aa]/40 to-[#00b896]/40 text-[#0a0f1a]/60 font-semibold text-sm cursor-not-allowed opacity-60"
                        >
                            🚧 Coming Soon — Airachne API Integration Pending
                        </button>
                    </div>
                )}
                ...
                {step === "preview" && (
                    <div className="bg-[#0f1019] border border-white/10 rounded-2xl p-6 space-y-5">
                        <h3 className="text-lg font-bold text-[#eae6df]">Confirm Claim</h3>
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex justify-between">
                                <span className="text-[#7a8a9d]">AIR balance (credential)</span>
                        ...
                        <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-3 text-xs text-yellow-300">
                            ⚠️ Each Airachne account can only claim once. Your AIR points are not deducted — they stay on Airachne.
                        </div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                disabled={true}
                                className="flex-1 py-3 rounded-xl bg-gradient-to-r from-[#00d4aa]/40 to-[#00b896]/40 text-[#0a0f1a]/60 font-semibold text-sm cursor-not-allowed opacity-60"
                            >
                                🚧 Coming Soon
                            </button>
                        </div>
                ...
                {step === "done" && result && (
                    <div className="bg-[#0f1019] border border-[#00d4aa]/30 rounded-2xl p-6 text-center space-y-5">
                        ...
                        <h3 className="text-xl font-bold text-[#eae6df]">Points Claimed!</h3>
                        ...
                        <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4 space-y-2 text-sm">
                            <div className="flex justify-between">
                                <span className="text-[#7a8a9d]">AIR used as credential</span>
