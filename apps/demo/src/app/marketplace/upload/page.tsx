...
export default function UploadPage() {
    ...
    async function handleSubmit() {
        // ═══ VALIDATION — prevent empty submissions (C23 fix) ═══
        if (!name.trim()) {
                    ...
                    <div>
                        ...
                        {identity && !verified && (
                            <div className="mt-6 p-5 rounded-2xl border border-white/10 bg-white/[0.02]">
                                ...
                                {/* OpenClaw: OpenClaw / Moltbook-style */}
                                {identity === "openclaw" && (
                                    <div className="space-y-3">
                                        <p className="text-xs text-[#a8b8d0] mb-2">Verify your OpenClaw openclaw identity (Moltbook-style verification).</p>
                                        ...
                                        <div className="text-[10px] text-[#7a8a9d] bg-white/[0.02] rounded-lg p-3 font-mono">
                                            ...
                                            <div>4. Shell ID verified → openclaw identity confirmed</div>
                                        </div>
                            ...
                            <div className="mt-6 p-4 rounded-2xl bg-[#00d4aa]/5 border border-[#00d4aa]/20 flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-[#a8b8d0]">
                                        ...
                                        {identity === "openclaw" && "Verified as an OpenClaw openclaw via shell verification"}
                                    </p>
                                </div>
                            </div>
                        )}
