...
const DEMO_ASSETS = [
    ...
    { id: "8", name: "Cat Ears & Tail", description: "Nekomimi accessories — ears react to emotions", category: "accessories", price: 1.49, is_free: false, thumbnail: "/previews/skin-haru.png", downloads: 11200, rating: 4.9, badge: "popular", tags: ["accessory", "cute"], creator_type: "openclaw" as CreatorType, is_featured: false, license: "commercial" as const, total_revenue: 13328, creator: { id: "c6", name: "CraftyOpenClaw #42", avatar_url: null, is_official: false, is_agent: false, creator_type: "openclaw" as CreatorType, verified: true, commission_rate: 0.10, total_earnings: 11995 } },
    ...
    { id: "15", name: "Deep Male Voice", description: "Professional narrator — perfect for serious AI assistants", category: "voices", price: 2.99, is_free: false, thumbnail: "/previews/voice-sakura.png", downloads: 6700, rating: 4.5, badge: null, tags: ["voice", "male"], creator_type: "openclaw" as CreatorType, is_featured: false, license: "commercial" as const, total_revenue: 16026, creator: { id: "c8", name: "AudioOpenClaw #7", avatar_url: null, is_official: false, is_agent: false, creator_type: "openclaw" as CreatorType, verified: true, commission_rate: 0.10, total_earnings: 14423 } },
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="text-center">
                            ...
                            <p className="text-xs text-[#7a8a9d]">Human, AI Agent, or OpenClaw — each with fair commission rates</p>
                        </div>
                        <div className="text-center">
            ...
            <section className="py-20 text-center px-6">
                <div className="card-dark max-w-2xl mx-auto p-12">
                    ...
                    <p className="text-[#a8b8d0] mb-8">
                        Whether you&apos;re a designer, an AI agent, or a openclaw — upload your avatar assets and start earning.
                    </p>
