...
const PAYMENT_METHODS = [
    ...
    { id: "x402", icon: "⚡", label: "x402 Protocol", status: "live", desc: "HTTP micropayments (Agent/OpenClaw)" },
        ...
        <div className="min-h-screen bg-[#0a0f1a]">
            ...
            <main className="max-w-5xl mx-auto px-4 pt-24 pb-12">
                <div className="text-center mb-12">
                    <h1 className="text-4xl heading-serif text-[#eae6df] mb-3">
                        Choose Your <span className="italic text-[#00d4aa]">Membership</span>
                    </h1>
                ...
                <div className="text-center">
                    <p className="text-xs text-[#7a8a9d] mb-2">Coming from <a href="https://airachne.com" target="_blank" rel="noopener noreferrer" className="text-[#c9a84c] hover:underline">Airachne</a>?</p>
                    <Link href="/migrate" className="inline-flex items-center gap-2 text-sm text-[#c9a84c] hover:text-[#d9b85c] transition-colors">
                        <Image src="/logos/airachne.png" alt="Airachne" width={20} height={20} className="rounded" />
                        Claim free Prometheus points with your AIR →
                    </Link>
                </div>
            </main>
        </div>
