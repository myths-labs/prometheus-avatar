...
const FEATURES = [
    ...
    { icon: "📦", title: "Developer SDK", description: "Integrate avatars into any app — works for humans, AI agents, and openclaws alike.", accent: "from-[#4aecd0] to-[#c9a84c]" },
];
    ...
    return (
        <section id="features" className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
            ...
            <div className="stats-row mt-20">
                ...
                <div className="stat-item">
                    <div className="stat-number">v0.8.0</div>
